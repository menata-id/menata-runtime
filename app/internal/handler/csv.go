...
func (h *Handler) ImportCSVForm(w http.ResponseWriter, r *http.Request) {
	...
	a := h.auth(r)
	page := ui.ImportCSV(h.workspaceName(r), h.workspaceSlug(r), a.User.Name, a.CSRFToken, h.isWorkspaceAdmin(r), machine, h.csvFieldIDs(machine), nil, h.unreadCount(r.Context(), a), h.subNavFor(r, machine))
...
func (h *Handler) ImportCSV(w http.ResponseWriter, r *http.Request) {
	...
	a := h.auth(r)
	page := ui.ImportCSV(h.workspaceName(r), h.workspaceSlug(r), a.User.Name, a.CSRFToken, h.isWorkspaceAdmin(r), machine, h.csvFieldIDs(machine), results, h.unreadCount(r.Context(), a), h.subNavFor(r, machine))
	if err := page.Render(r.Context(), w); err != nil {
